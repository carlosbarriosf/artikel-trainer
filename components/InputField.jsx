...
const InputField = forwardRef((props, ref) => {
  ...
  return (
    <div className='w-full grid grid-cols-2 gap-4'>
        <label htmlFor="article" className='justify-self-center self-center md:justify-self-end capitalize'>{name}</label>
        <div className='w-3/4 max-w-md relative'>
            ...
            >
                <FaCircleInfo  />
                {isInfoHovered[name] && <p className={`'appear absolute text-xs w-48 sm:w-64 bg-gray-700 text-white p-2 right-0 bottom-8 z-10 rounded-lg bg-opacity-95`}>
                    {infoText}
                </p>}
            </div>  
            </div>
